...
namespace WebAppCSC4008
{
	...
	partial class App : Windows.UI.Xaml.Application
	{
		private void InitializeComponent()
		{
			...
			.Apply((c0 => 
			{
				// Source C:\dev\csc4008-teamg\WebAppCSC4008\WebAppCSC4008\WebAppCSC4008.Shared\App.xaml (Line 1:2)
			...
			global::WebAppCSC4008.Droid.GlobalStaticResources.Initialize();
			global::WebAppCSC4008.Droid.GlobalStaticResources.RegisterResourceDictionariesBySourceLocal();
			global::Uno.UI.DataBinding.BindableMetadata.Provider = new global::WebAppCSC4008.Droid.BindableMetadataProvider();
			#if __ANDROID__
			global::Uno.Helpers.DrawableHelper.Drawables = typeof(global::WebAppCSC4008.Droid.Resource.Drawable);
			#endif
			// MergedDictionaries
			...
			// Source ..\..\..\..\..\..\..\WebAppCSC4008.Shared\App.xaml (Line 1:2)
		}
	}
}
namespace WebAppCSC4008.Droid
{
	static class App_7a6bd93c00a0087f77504e9cd827af4dXamlApplyExtensions
	{
	}
}
